...
Conducts MAGMA GSEA for a single phenotype
...
def main(args = None, **kwargs):
    ...
    submitter = array_submitter('sc_magma_gsea_'+'_'.join(args.pheno),
        n_cpu = 1, timeout = 240, parallel = 4, modules = ['gcc/11'], env = 'base')
...
if __name__ == '__main__':
    ...
    parser = slurm_parser('This script runs cell-type/pathway enrichments using MAGMA GSEA')
