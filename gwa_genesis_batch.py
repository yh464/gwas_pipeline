...
def main(args):
  ...
  submitter = array_submitter(name = f'gwa_genesis_{args.pheno}', timeout = 90, n_cpu = 4, env = 'gentoolsr',
                              dependency = [grm_submitter])
  ...
  for g in args.pheno:
    ...
    for p in hdr[2:]:
      ...
      cmd = ['Rscript', 'gwa_genesis.r', p, '-i', pheno_file, '-o', outdir, '-b', args.bed, '--dcov', args.dcov, '--qcov', args.qcov]
...
if __name__ == '__main__':
  ...
  parser.add_argument('--dcov',dest = 'dcov', help = 'DISCRETE covariance file', default = '../params/abcd_dcov.txt')
  parser.add_argument('--qcov',dest = 'qcov', help = 'QUANTITATIVE covariance file', default = '../params/abcd_qcov.txt')
