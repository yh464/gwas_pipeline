...
def main(args):
    ...
    submitter = array_submitter(name = 'sc_score', n_cpu = 16, timeout = 480, env = 'sctoolsr')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--label', nargs = '*', help = 'Columns containing cell classifications/annotations in the h5ad dataset',
        default = ['ROIGroup', 'ROIGroupFine', 'roi', 'supercluster_term', 'cluster_id', 'subcluster_id', 'development_stage'])
