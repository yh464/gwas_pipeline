...
def main(args):
  ...
  for line in fin:
    ...
    if idx % 5000 == 0:
      toc = t() - tic
      log.log(f'read {idx} subjects. time = {toc:.2f} seconds')
...
if __name__ == '__main__':
  ...
  parser.add_argument('-i','--in', dest = '_in', help = 'input ukb fetch file, CSV format',
    default = '/home/yh464/rds/rds-rb643-ukbiobank2/Data_Phenotype/DataFetch_20022024/ukb677594.csv')
    # default = '/home/yh464/rds/rds-rb643-ukbiobank2/Data_Phenotype/DataFetch_09052025/ukb679961.csv')
